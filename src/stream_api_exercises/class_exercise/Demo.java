...
public class Demo {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(bookService.filterBooksAfterSpecifiedYear(1992,books)));
        System.out.println(Arrays.toString(bookService.filterBooksByAuthor(books[0].getAuthors()[0], books)));
        System.out.println(Arrays.toString(bookService.filterBooksByPublisher(books[0].getPublisher(), books)));
    }
}
